      ...
      <section className="bg-white py-24 px-6 dark:bg-zinc-950 lg:px-12">
        <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[2fr_3fr]">
          <div className="space-y-6 text-zinc-900 dark:text-white">
            <FadeIn>
              <div
                className={`${EYEBROW_TEXT} text-zinc-400 dark:text-white/60`}
              >
                {t("channels.eyebrow")}
              </div>
            </FadeIn>
            ...
            <div className="space-y-4">
              {channels.map((channel, idx) => {
                ...
                return (
                  <FadeIn key={channel.title} delay={0.05 + idx * 0.05}>
                    <a
                      href={channel.href}
                      target={target}
                      rel={rel}
          ...
          <FadeIn delay={0.1} className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-8 shadow-[0_25px_90px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/5">
