      ...
      <section className="relative overflow-hidden py-24 px-6 text-white lg:px-12">
        ...
        <div className="relative z-10 mx-auto max-w-7xl space-y-12">
          <div className="space-y-6">
            ...
            <FadeIn delay={0.05}>
              <h2 className={`${SECTION_HEADING}`}>{philosophy.title}</h2>
            </FadeIn>
          </div>
          <div className="grid gap-8 lg:grid-cols-2">
            <FadeIn className="rounded-3xl border border-white/15 bg-white/5 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.35)] backdrop-blur-2xl transition hover:border-white/30 hover:bg-white/10">
              <div
            ...
            <FadeIn className="rounded-3xl border border-white/15 bg-linear-to-br from-white/5 to-white/10 p-8 shadow-[0_25px_90px_rgba(0,0,0,0.3)]">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {process.steps.map((step) => {
              ...
              return (
                ...
                >
                  <p className={`${EYEBROW_TEXT} text-white/40`}>{step.tag}</p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {metrics.items.map((metric) => (
              <FadeIn
                key={metric.label}
                delay={0.06 + metric.label.length * 0.001}
